...
contenu <- gsub('^(\\s*title:\\s*).*$', paste0('title: "', titre_reel, '"'), contenu)
...
contenu2 <- gsub('^(\\s*title:\\s*).*$', paste0('title: "', titre_history, '"'), contenu2)
...
contenu3 <- gsub('^(\\s*title:\\s*).*$', paste0('title: "', titre_conservation, '"'), contenu3)
...
contenu3 <- gsub('^(\\s*title:\\s*).*$', paste0('title: "', titre_spatial, '"'), contenu4)
