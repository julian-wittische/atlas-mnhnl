...
map_species_richness_by_commune <- function(DB2, communes_data = communes_2169) {
  
  DB2_sf <- st_as_sf(DB2, coords = c("Long", "Lat"), crs = 4326) %>%
    st_transform(2169)
...
map_species_richness_by_commune(DB2)
