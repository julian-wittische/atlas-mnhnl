...
############ Loading libraries ----
source("Atlas/code/0_Initialisation.R")
...
# NOTE: correction de coordonnée déplacée ici, avant utilisation de BC dans DB
# (dans ta version précédente elle arrivait trop tard, après la construction de DB_sf)
